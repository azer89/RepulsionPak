...
if __name__ == "__main__":
    ...
    sq_1_radius = 100;
    sq_1_side = sq_1_radius / np.sqrt(2);
    duhh = sq_1_side + skin_thickness;
    sq_2_radius = np.sqrt(2.0 * duhh * duhh);
    
    poly_1 = ut.CreatePoly(num_side, center_pt, sq_1_radius);   
    poly_2 = ut.CreatePoly(num_side, center_pt, sq_2_radius);  
