...
for num_name in num_names:
    ...
    # MASK
    filename1 = 'C://Users//azer//OneDrive//__results__//30_' + case_name + '_' + num_name +'//dist_mask.csv';
    csv_data1 = pd.read_csv(filename1, sep=',',header=None);
    print filename1;
    mask_vals = csv_data1.values[:,0];
    
    # SDF
    filename2 = 'C://Users//azer//OneDrive//__results__//30_' + case_name + '_' + num_name +'//dist_all.csv';
