...
if __name__ == "__main__":
    ...
    tri_1_radius = 100;
    tri_1_side = tri_1_radius / 2.0;
    tri_2_radius = 2.0 * (tri_1_side + skin_thickness); 
    
    poly_1 = ut.CreatePoly(num_side, center_pt, tri_1_radius);   
    poly_2 = ut.CreatePoly(num_side, center_pt, tri_2_radius);     
